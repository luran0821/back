...
if($(".lmc-reconciliation").length!=0){
    ...
    var initUserList = function () {
        ...
        if (oTable == null) { //仅第一次检索时初始化Datatable
            oTable = table.dataTable({
                ...
                //ajax地址
                "sAjaxSource": pathurl + "LMC/statement",// 请求路径
                ...
                "columnDefs" : [ {
                    ...
                    "render" : function(data, type,row) {
                        ...
                        if(row.be_from==1) {
                            html = "发币";
                        }else if(row.be_from==2){
                            html = "收币";
                        }else if(row.be_from==3){
                            html = "转账";
                        }
                        return html;
                    }
                    ...
                    "render" : function(data, type,row) {
                        ...
                        if(row.be_type==1) {
                            html = "只存在LBS";
                        }else if(row.be_type==2){
                            html = "只存在钱包";
                        }else if(row.be_type==3){
                            html = "金额错误";
                        }
                        return html;
                    }
        ...
        $(".search").on("click",function () {
            ...
            $(".center .top input").each(function (i) {
                if(i!=0) {
                    ...
                    if ($(".center .top input").eq(0).val() != ""&&$(".center .top input").eq(0).val().length!=6) {
                        isempty = true;
                        return isempty;
                    }
                }
